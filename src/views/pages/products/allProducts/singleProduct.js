...
function SingleProduct(props) {
    ...
    const handleGetProductInfo = () => {
        ...
        api.productSingle(id).then(res => {
            console.log(res, 'handleGetProductInfo')
            ...
            setProductInfo({ ...res.data, gallery: galleryIds, image_id: res.data.image.id, video_id: res.data.video.id, category_ids: res.data.categories })
    ...
    const handleUpdateProduct = (data) => {
        api.productUpdate(props.location.state.data.id, data).then(res => {
            console.log(res, 'product  update')
            history.goBack()
                        ...
                        <div class="inputwithdesc">
                            <div class="input">
                                ...
                                <input
                                    ...
                                    value={productInfo.minimum_purchase}
