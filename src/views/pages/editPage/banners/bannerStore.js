...
function BannerStore() {
    ...
    const handleStoreBanner = (data) => {
        console.log(data, 'data')
        api.bannersStore(data).then(res => {
    ...
    console.log(colors)
    console.log(banerInfo, 'bannerinfo')
    return (
        <main>
            <header>
                ...
                <div class="conectoptions">
                    ...
                    <label class="container" for="yellow1">
                        <div class="inputwithdesc">
                            <div class="input">
                                <p>لینک بیرونی:</p>
                                <input onChange={(e) => handleOnchangeInfo({ value: e.target.value, name: 'link' })} type="text" id="productname" name="productname" class="w40" />
                            </div>
                            <p class="inputdesc"></p>
                        </div>
                        <input
